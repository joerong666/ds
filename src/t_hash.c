...
void hsetCommand(redisClient *c)
{
    ...
    dbmng_save_op(c->tag, OP_HMSET, c->argv[1], c->argc - 2, &c->argv[2], c->ds_id, c->db->id);
...
void hincrbyCommand(redisClient *c)
{
    ...
    argv[0] = c->argv[2];
    argv[1] = new;
    dbmng_save_op(c->tag, OP_HMSET, c->argv[1], 2, argv, c->ds_id, c->db->id);
...
void hdelCommand(redisClient *c)
{
    ...
    dbmng_save_op(c->tag, OP_HDEL, c->argv[1], c->argc - 2, &c->argv[2], c->ds_id, c->db->id);
